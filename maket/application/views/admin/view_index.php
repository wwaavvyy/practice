    ...
    <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
				  <div class="row tile_count"> 
					<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
						  <span class="count_top"><i class="glyphicon glyphicon-bed"></i> Всего транспорта </span>
						  <div class="count"><?php echo count($vehicles); ?></div>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
						  <span class="count_top"><i class="glyphicon glyphicon-bed"></i> Всего сотрудников </span>
						  <div class="count"><?php echo count($employees); ?></div>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
						  <span class="count_top"><i class="glyphicon glyphicon-bed"></i> Всего клиентов </span>
						  <div class="count"><?php echo count($customers); ?></div>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
					  	<span class="count_top"><i class="glyphicon glyphicon-bed"></i> Всего продано </span>
					  	<div class="count">
					  		<?php $price = 0; ?>
        ...
        <div class="row">
        	<div class="col-md-6 col-xs-12">
              	<div class="x_panel tile fixed_height_320">
                	<div class="x_title">
                  		<h2>Число производителей авто</h2>
            ...
            <div class="col-md-6 col-xs-12">
              	<div class="x_panel tile fixed_height_320">
                	<div class="x_title">
                  		<h2>Число проданных авто по производителям</h2>
	                  		<ul class="nav navbar-right panel_toolbox">
	                    	<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
	                        <li><a class="close-link"><i class="fa fa-close"></i></a></li>
                  		</ul>
        ...
        <div class="row">
        	<div class="col-md-6 col-xs-12">
        	  <div class="x_panel">
        	    <div class="x_title">
        	      	<h2>Гистограмма<small>Сессии</small></h2>
        	     	<ul class="nav navbar-right panel_toolbox">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">Настройки 1</a></li>
								<li><a href="#">Настройки 2</a></li>
							</ul>
						</li>
						<li><a class="close-link"><i class="fa fa-close"></i></a></li>
        	      	</ul>
