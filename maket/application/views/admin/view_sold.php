...
<div class="right_col" role="main">
    <div class="">
		...
		<div style="display:inline">Фильтр проданного транспорта</div>
			<div class="input-append date datepicker divDatePicker inline" id="datepicker" style="margin:0px;padding:0px;display:inline">
			<input type="text" class="datepicker input-small validation rightBorderNone otherTabs" id="fromDate" name="displayDate" placeholder="От даты" />
        ...
        <input type="text" placeholder="До даты" class="datepicker input-small validation rightBorderNone otherTabs" id="toDate" name="displayDate" />
        <button class="btn leftBorderNone" type="button"><i class="glyphicon glyphicon-calendar"></i></button>
		</div>
		</div>
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>ИД</th>
                                    <th>Контакты</th>
                                    <th>Год выпуска<br></th>
                                    <th>Модель<br></th>
                                    <th>Стоимость &amp; Прибыль</th>
                                    <th>Дата аренды</th>
                            ...
                            <tbody>
                                ...
                                <td><?php echo "Имя: ".$vehicle['cf_name']." ".$vehicle['cl_name']."<br>Email: ".$vehicle['c_email']."<br>Номер телефона: ".$vehicle['c_mobile']; ?></td>
                                <td><?php echo $vehicle['manufacturer_name']; ?></td>
                                <td><?php echo $vehicle['model_name']; ?></td>
                                <td><?php echo "Стоимость: ".$vehicle['buying_price']."<br>Продано за: ".$vehicle['selling_price']."<br>Прибыль: ".($vehicle['selling_price']-$vehicle['buying_price']); ?></td>
                            ...
                            <td>
                                    ...
                                    <?php echo form_open('admin/vehicles/DeleteCustomer/'); ?>
                                        ...
                                        <button onclick="return confirm('Записи этого клиента будут удалены, вы уверены?')" class="btn btn-xs btn-danger" type="submit" name="btn-delete">Удалить</button>
                                    </form>
                                <?php endif; ?>
                            </td>
